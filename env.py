...
INGEST_DIR_BOOK_FICTION = Path(os.getenv("INGEST_DIR_BOOK_FICTION", ""))
INGEST_DIR_BOOK_NON_FICTION = Path(os.getenv("INGEST_DIR_BOOK_NON_FICTION", ""))
INGEST_DIR_BOOK_UNKNOWN = Path(os.getenv("INGEST_DIR_BOOK_UNKNOWN", ""))
INGEST_DIR_MAGAZINE = Path(os.getenv("INGEST_DIR_MAGAZINE", ""))
INGEST_DIR_COMIC_BOOK = Path(os.getenv("INGEST_DIR_COMIC_BOOK", ""))
INGEST_DIR_AUDIOBOOK = Path(os.getenv("INGEST_DIR_AUDIOBOOK", ""))
INGEST_DIR_STANDARDS_DOCUMENT = Path(os.getenv("INGEST_DIR_STANDARDS_DOCUMENT", ""))
INGEST_DIR_MUSICAL_SCORE = Path(os.getenv("INGEST_DIR_MUSICAL_SCORE", ""))
